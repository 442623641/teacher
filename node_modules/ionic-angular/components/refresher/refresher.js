...
var Refresher = (function () {
    ...
    Refresher.prototype._onMove = function (ev) {
        ...
        if (this.state === STATE_INACTIVE) {
            ...
            // if the scrollTop is greater than zero then it's
            // not possible to pull the content down yet
            if (scrollHostScrollTop > 0||!this._isReady) {
                this.progress = 0;
                this.startY = null;
                return 7;
            }
    ...
    Refresher.prototype._setCss = function (y, duration, overflowVisible, delay) {
        this._appliedStyles = (y > 25);
        var /** @type {?} */ content = this._content;
        var /** @type {?} */ Css = this._plt.Css;
        content.setScrollElementStyle(Css.transform, ((y > 25) ? 'translateY(' + (y-25) + 'px) translateZ(0px)' : 'translateZ(0px)'));
