...
export class changepassword2Page {
  ...
  constructor(public navCtrl: NavController,public toastCtrl:ToastController,public navParams: NavParams,
              public appService:AppService,public userService:UserService, public appCtrl: App,
              public alertCtrl: AlertController,private nativeService:NativeService, ) {
    //获取上一个页面传递的参数
  ...
  changepassWrod(){
    ...
    this.appService.changePassWord(this.data).then(v=>{

      this.spinner=false;
      this.pass.newpassword='';
      this.pass.password='';
      if(v.result) {
        this.presentAlert("密码修改成功，请重新登陆！");
        return;
      }
      else{
